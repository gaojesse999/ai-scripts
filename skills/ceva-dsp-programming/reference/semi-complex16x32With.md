# Multiplication → Multiply-Accumulate → Semi-Complex 16x32 with

*Auto-generated from CEVA-XC4500 Vec-C Intrinsics documentation*

---

Main table → Multiplication → Multiply-Accumulate → Semi-Complex 16x32 with
Exponent

Semi-Complex 16x32 with Exponent

Semi-Complex 16x32 with Exponent
Performs semi-complex multiply-accumulate with exponent between a complex number and a
...
Conj       conjugate complex operation
           ...
           multiply-accumulate 16x32 with exponent operation.Used for two vector destinations,
Ohop
           ...
           Number of atomic operations. An atomic operation is defined as a semi-complex
Qop
           multiply-accumulate 16x32 with exponent operation.
vmpsX Selects the VMSNX and VPSX set within modv0 or modv2 mode registers.
Intrinsic Names
vmacwlxre_v32_v32_v32_v40_v40_conj
vmacwlxre_v32_v32_v32_v40_v40_conj_vmpsX
vmacwlxre_v32_v32_v32_v40_v40
vmacwlxre_v32_v32_v32_v40_v40_vmpsX
vmacwlxre_v32_v32_v32_v40_conj
vmacwlxre_v32_v32_v32_v40_conj_vmpsX
vmacwlxre_v32_v32_v32_v40
vmacwlxre_v32_v32_v32_v40_vmpsX
Instruction details in the instruction set specification
Intrinsic     vmacwlxre_v32_v32_v32_v40_v40_conj[_p]
name
Spec syntax   vmacwlxre {Ohop [,conj][,vmpsX]} vx[X], vy[Y], vv[V]p, voz1[0], voz2[0], ?vprX
...
C example     vec40_t vRes2;
              vprex_t vecPred;
              ...
              vRes1 = vmacwlxre_v32_v32_v32_v40_v40_conj_p (8, vIn, 0, vIn2, 0, vIn3, 0, LOW, vRes1, vRes2,
              vecPred);

                   IN_VPR last operand is relevant only for
              1.
                   vmacwlxre_v32_v32_v32_v40_v40_conj_p version.
...
Main table → Multiplication → Multiply-Accumulate → Semi-Complex 16x32 with
Exponent
Intrinsic     vmacwlxre_v32_v32_v32_v40_v40_conj_vmpsX[_p]
name
Spec syntax   vmacwlxre {Ohop [,conj][,vmpsX]} vx[X], vy[Y], vv[V]p, voz1[0], voz2[0], ?vprX
...
C example     vec40_t vRes2;
              vprex_t vecPred;
              ...
              vRes1 = vmacwlxre_v32_v32_v32_v40_v40_conj_vmpsX_p (8, 1, vIn, 0, vIn2, 0, vIn3, 0, LOW, vRes1,
              vRes2, vecPred);

              1.
                   IN_VPR last operand is relevant only for
                   vmacwlxre_v32_v32_v32_v40_v40_conj_vmpsX_p version.
Comments           This intrinsic returns two results. The first result variable should be placed to
              2.   the left of the = sign (lvalue). The second result variable should be passed as
                   an additional parameter (RES2_V40).
...
Main table → Multiplication → Multiply-Accumulate → Semi-Complex 16x32 with
Exponent
Intrinsic     vmacwlxre_v32_v32_v32_v40_v40[_p]
name
Spec syntax   vmacwlxre {Ohop [,conj][,vmpsX]} vx[X], vy[Y], vv[V]p, voz1[0], voz2[0], ?vprX
...
C example     vec40_t vRes2;
              vprex_t vecPred;
              ...
              vRes1 = vmacwlxre_v32_v32_v32_v40_v40_p (8, vIn, 0, vIn2, 0, vIn3, 0, LOW, vRes1, vRes2, vecPred);

                   IN_VPR last operand is relevant only for
              1.
                   vmacwlxre_v32_v32_v32_v40_v40_p version.
Comments           This intrinsic returns two results. The first result variable should be placed to
              2.   the left of the = sign (lvalue). The second result variable should be passed as
                   an additional parameter (RES2_V40).
...
Main table → Multiplication → Multiply-Accumulate → Semi-Complex 16x32 with
Exponent
Intrinsic     vmacwlxre_v32_v32_v32_v40_v40_vmpsX[_p]
name
Spec syntax   vmacwlxre {Ohop [,conj][,vmpsX]} vx[X], vy[Y], vv[V]p, voz1[0], voz2[0], ?vprX
...
C example   vec40_t vRes2;
            vprex_t vecPred;
            ...
            vRes1 = vmacwlxre_v32_v32_v32_v40_v40_vmpsX_p (8, 1, vIn, 0, vIn2, 0, vIn3, 0, LOW, vRes1, vRes2,
            vecPred);

                 IN_VPR last operand is relevant only for
            1.
                 vmacwlxre_v32_v32_v32_v40_v40_vmpsX_p version.
Comments         This intrinsic returns two results. The first result variable should be placed to
            2.   the left of the = sign (lvalue). The second result variable should be passed as
                 an additional parameter (RES2_V40).
...
Main table → Multiplication → Multiply-Accumulate → Semi-Complex 16x32 with
Exponent
Intrinsic     vmacwlxre_v32_v32_v32_v40_conj[_p]
name
Spec syntax   vmacwlxre {Qop [,conj][,vmpsX]} vx[X], vy[Y], vv[V]p, voz[0], ?vprX
...
C example     vec40_t vRes;
              vprex_t vecPred;
              ...
              vRes = vmacwlxre_v32_v32_v32_v40_conj_p (4, vIn, 0, vIn2, 0, vIn3, 0, LOW, vRes, vecPred);

                   IN_VPR last operand is relevant only for
Comments      1.
                   vmacwlxre_v32_v32_v32_v40_conj_p version.


Main table → Multiplication → Multiply-Accumulate → Semi-Complex 16x32 with
Exponent
Intrinsic     vmacwlxre_v32_v32_v32_v40_conj_vmpsX[_p]
name
Spec syntax   vmacwlxre {Qop [,conj][,vmpsX]} vx[X], vy[Y], vv[V]p, voz[0], ?vprX
...
C example     vec40_t vRes;
              vprex_t vecPred;
              ...
              vRes = vmacwlxre_v32_v32_v32_v40_conj_vmpsX_p (4, 1, vIn, 0, vIn2, 0, vIn3, 0, LOW, vRes, vecPred);

                   IN_VPR last operand is relevant only for
Comments      1.
                   vmacwlxre_v32_v32_v32_v40_conj_vmpsX_p version.

Main table → Multiplication → Multiply-Accumulate → Semi-Complex 16x32 with
Exponent
Intrinsic     vmacwlxre_v32_v32_v32_v40[_p]
name
Spec syntax   vmacwlxre {Qop [,conj][,vmpsX]} vx[X], vy[Y], vv[V]p, voz[0], ?vprX
...
C example     vec40_t vRes;
              vprex_t vecPred;
              ...
              vRes = vmacwlxre_v32_v32_v32_v40_p (4, vIn, 0, vIn2, 0, vIn3, 0, LOW, vRes, vecPred);

                   IN_VPR last operand is relevant only for vmacwlxre_v32_v32_v32_v40_p
Comments      1.
                   version.
...
Main table → Multiplication → Multiply-Accumulate → Semi-Complex 16x32 with
Exponent
Intrinsic     vmacwlxre_v32_v32_v32_v40_vmpsX[_p]
name
Spec syntax   vmacwlxre {Qop [,conj][,vmpsX]} vx[X], vy[Y], vv[V]p, voz[0], ?vprX
...
C example     vec40_t vRes;
              vprex_t vecPred;
              ...
              vRes = vmacwlxre_v32_v32_v32_v40_vmpsX_p (4, 1, vIn, 0, vIn2, 0, vIn3, 0, LOW, vRes, vecPred);

                   IN_VPR last operand is relevant only for
Comments      1.
                   vmacwlxre_v32_v32_v32_v40_vmpsX_p version.
