# Multiplication → Multiply-Accumulate → Semi-Complex 32x16 with

*Auto-generated from CEVA-XC4500 Vec-C Intrinsics documentation*

---

Main table → Multiplication → Multiply-Accumulate → Semi-Complex 32x16 with
Exponent
...
real number. The complex source consists of real 32-bit part and imaginary 32-bit part. The real
source consists of real 16-bit part. Each of the real and the imaginary products are accumulated
with the 40-bit destination respectively.
Available Switches
Conj           conjugate complex operation
               Number of atomic operations. An atomic operation is defined as a 32x16 semi-
Qop
               complex multiply-accumulate with exponent operation. 1op ≤ Qop ≤ 4op
vmpsX          Selects the VMSNX and VPSX set within modv0 or modv2 mode registers.
Intrinsic Names
vmaclwxre_v32_v32_v32_v40_conj
vmaclwxre_v32_v32_v32_v40_conj_vmpsX
vmaclwxre_v32_v32_v32_v40
vmaclwxre_v32_v32_v32_v40_vmpsX
Instruction details in the instruction set specification
Intrinsic     vmaclwxre_v32_v32_v32_v40_conj[_p]
name

Spec syntax   vmaclwxre {Qop [,conj][,vmpsX]} vx[Xe], vy[Y]p, vv[V]p, voz[0], ?vprX
...
C example     vec40_t vRes;
              vprex_t vecPred;
              ...
              vRes = vmaclwxre_v32_v32_v32_v40_conj_p (4, vIn, 0, vIn2, 0, LOW, vIn3, 0, LOW, vRes, vecPred);

                   IN_VPR last operand is relevant only for
Comments      1.
                   vmaclwxre_v32_v32_v32_v40_conj_p version.


Main table → Multiplication → Multiply-Accumulate → Semi-Complex 32x16 with
Exponent
Intrinsic     vmaclwxre_v32_v32_v32_v40_conj_vmpsX[_p]
name
Spec syntax   vmaclwxre {Qop [,conj][,vmpsX]} vx[Xe], vy[Y]p, vv[V]p, voz[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vRes = vmaclwxre_v32_v32_v32_v40_conj_vmpsX_p (4, 1, vIn, 0, vIn2, 0, LOW, vIn3, 0, LOW, vRes,
              vecPred);

                   IN_VPR last operand is relevant only for
Comments      1.
                   vmaclwxre_v32_v32_v32_v40_conj_vmpsX_p version.


Main table → Multiplication → Multiply-Accumulate → Semi-Complex 32x16 with
Exponent
Intrinsic     vmaclwxre_v32_v32_v32_v40[_p]
name
Spec syntax   vmaclwxre {Qop [,conj][,vmpsX]} vx[Xe], vy[Y]p, vv[V]p, voz[0], ?vprX
...
C example     vec40_t vRes;
              vprex_t vecPred;
              ...
              vRes = vmaclwxre_v32_v32_v32_v40_p (4, vIn, 0, vIn2, 0, LOW, vIn3, 0, LOW, vRes, vecPred);

                   IN_VPR last operand is relevant only for vmaclwxre_v32_v32_v32_v40_p
Comments      1.
                   version.
...
Main table → Multiplication → Multiply-Accumulate → Semi-Complex 32x16 with
Exponent
Intrinsic     vmaclwxre_v32_v32_v32_v40_vmpsX[_p]
name
Spec syntax   vmaclwxre {Qop [,conj][,vmpsX]} vx[Xe], vy[Y]p, vv[V]p, voz[0], ?vprX
...
            vec40_t vRes;
            vprex_t vecPred;
            ...
            vRes = vmaclwxre_v32_v32_v32_v40_vmpsX_p (4, 1, vIn, 0, vIn2, 0, LOW, vIn3, 0, LOW, vRes,
            vecPred);

                 IN_VPR last operand is relevant only for
Comments    1.
                 vmaclwxre_v32_v32_v32_v40_vmpsX_p version.
