# Multiplication → Multiply-Subtract → 16x8 using Two Products into Two

*Auto-generated from CEVA-XC4500 Vec-C Intrinsics documentation*

---

Main table → Multiplication → Multiply-Subtract → 16x8 using Two Products into Two
Words
...
Performs two multiply-subtract operations between two sources and a constant, using two
products. The sources are 16-bit wide each and a constant of 8-bit. The products are subtracted
...
Oop
               subtract using two products operations. 1op ≤ Oop ≤ 8op
...
Intrinsic Names
vmsuwb3_v32_v32_c32_v40_low
vmsuwb3_v32_v32_c32_v40_low_vmpsX
vmsuwb3_v32_v32_c32_v40
vmsuwb3_v32_v32_c32_v40_vmpsX
Instruction details in the instruction set specification
Intrinsic     vmsuwb3_v32_v32_c32_v40_low[_p]
name
Spec syntax   vmsuwb3 {Oop [,low][,vmpsX]} vx[X]p, vy[Y]p, vcWp, voz[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vRes = vmsuwb3_v32_v32_c32_v40_low_p (8, vIn, 0, LOW, vIn2, 0, LOW, vcoefIn, LOW, vRes,
              vecPred);

IN_VPR last operand is relevant only for
Comments      1.
                   vmsuwb3_v32_v32_c32_v40_low_p version.


Main table → Multiplication → Multiply-Subtract → 16x8 using Two Products into Two
Words
Intrinsic     vmsuwb3_v32_v32_c32_v40_low_vmpsX[_p]
name
Spec syntax   vmsuwb3 {Oop [,low][,vmpsX]} vx[X]p, vy[Y]p, vcWp, voz[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vRes = vmsuwb3_v32_v32_c32_v40_low_vmpsX_p (8, 1, vIn, 0, LOW, vIn2, 0, LOW, vcoefIn, LOW,
              vRes, vecPred);

                   IN_VPR last operand is relevant only for
Comments      1.
                   vmsuwb3_v32_v32_c32_v40_low_vmpsX_p version.


Main table → Multiplication → Multiply-Subtract → 16x8 using Two Products into Two
Words
Intrinsic     vmsuwb3_v32_v32_c32_v40[_p]
name
Spec syntax   vmsuwb3 {Oop [,low][,vmpsX]} vx[X]p, vy[Y]p, vcWp, voz[0], ?vprX
...
C example     coef_t vcoefIn;
              vprex_t vecPred;
              ...
              vRes = vmsuwb3_v32_v32_c32_v40_p (8, vIn, 0, LOW, vIn2, 0, LOW, vcoefIn, LOW, vRes, vecPred);

                   IN_VPR last operand is relevant only for vmsuwb3_v32_v32_c32_v40_p
Comments      1.
                   version.
...
Main table → Multiplication → Multiply-Subtract → 16x8 using Two Products into Two
Words
Intrinsic     vmsuwb3_v32_v32_c32_v40_vmpsX[_p]
name
Spec syntax   vmsuwb3 {Oop [,low][,vmpsX]} vx[X]p, vy[Y]p, vcWp, voz[0], ?vprX
...
C example     coef_t vcoefIn;
              vprex_t vecPred;
              ...
            vRes = vmsuwb3_v32_v32_c32_v40_vmpsX_p (8, 1, vIn, 0, LOW, vIn2, 0, LOW, vcoefIn, LOW, vRes,
            vecPred);

                 IN_VPR last operand is relevant only for
Comments    1.
                 vmsuwb3_v32_v32_c32_v40_vmpsX_p version.
