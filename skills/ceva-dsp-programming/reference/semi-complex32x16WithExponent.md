# Multiplication → Multiply-Subtract → Semi-Complex 32x16 with Exponent

*Auto-generated from CEVA-XC4500 Vec-C Intrinsics documentation*

---

Main table → Multiplication → Multiply-Subtract → Semi-Complex 32x16 with Exponent
...
number. The complex source consists of real 32-bit part and imaginary 32-bit part. The real
source consists of real 16-bit part. Each of the real and the imaginary products are Subtractd with
...
Qop
                complex multiply-subtract with exponent operation. 1op ≤ Qop ≤ 4op
vmpsX           Selects the VMSNX and VPSX set within modv0 or modv2 mode registers.
Intrinsic Names
vmsulwxre_v32_v32_v32_v40_conj
vmsulwxre_v32_v32_v32_v40_conj_vmpsX
vmsulwxre_v32_v32_v32_v40
vmsulwxre_v32_v32_v32_v40_vmpsX

Instruction details in the instruction set specification
Intrinsic     vmsulwxre_v32_v32_v32_v40_conj[_p]
name
Spec syntax   vmsulwxre {Qop [,conj][,vmpsX]} vx[Xe], vy[Y]p, vv[V]p, voz[0], ?vprX
...
C example     vec40_t vRes;
              vprex_t vecPred;
              ...
              vRes = vmsulwxre_v32_v32_v32_v40_conj_p (4, vIn, 0, vIn2, 0, LOW, vIn3, 0, LOW, vRes, vecPred);

                   IN_VPR last operand is relevant only for
Comments      1.
                   vmsulwxre_v32_v32_v32_v40_conj_p version.


Main table → Multiplication → Multiply-Subtract → Semi-Complex 32x16 with Exponent
Intrinsic     vmsulwxre_v32_v32_v32_v40_conj_vmpsX[_p]
name
Spec syntax   vmsulwxre {Qop [,conj][,vmpsX]} vx[Xe], vy[Y]p, vv[V]p, voz[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vRes = vmsulwxre_v32_v32_v32_v40_conj_vmpsX_p (4, 1, vIn, 0, vIn2, 0, LOW, vIn3, 0, LOW, vRes,
              vecPred);

                   IN_VPR last operand is relevant only for
Comments      1.
                   vmsulwxre_v32_v32_v32_v40_conj_vmpsX_p version.


Main table → Multiplication → Multiply-Subtract → Semi-Complex 32x16 with Exponent
Intrinsic     vmsulwxre_v32_v32_v32_v40[_p]
name
Spec syntax   vmsulwxre {Qop [,conj][,vmpsX]} vx[Xe], vy[Y]p, vv[V]p, voz[0], ?vprX
...
C example     vec40_t vRes;
              vprex_t vecPred;
              ...
              vRes = vmsulwxre_v32_v32_v32_v40_p (4, vIn, 0, vIn2, 0, LOW, vIn3, 0, LOW, vRes, vecPred);

                   IN_VPR last operand is relevant only for vmsulwxre_v32_v32_v32_v40_p
Comments      1.
                   version.


Main table → Multiplication → Multiply-Subtract → Semi-Complex 32x16 with Exponent
Intrinsic     vmsulwxre_v32_v32_v32_v40_vmpsX[_p]
name
Spec syntax   vmsulwxre {Qop [,conj][,vmpsX]} vx[Xe], vy[Y]p, vv[V]p, voz[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vRes = vmsulwxre_v32_v32_v32_v40_vmpsX_p (4, 1, vIn, 0, vIn2, 0, LOW, vIn3, 0, LOW, vRes,
              vecPred);
                 IN_VPR last operand is relevant only for
Comments    1.
                 vmsulwxre_v32_v32_v32_v40_vmpsX_p version.
