# Floating Point → Float Division → Vector Floating Point Division (N-R)

*Auto-generated from CEVA-XC4500 Vec-C Intrinsics documentation*

---

Main table → Floating Point → Float Division → Vector Floating Point Division (N-R)

Vector Floating Point Division (N-R)
...
Intrinsic     vflpdivnr[_p]
name
Spec syntax   vflpdivnr vx[0], vz[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vflpdivnr_p(vIn, vRes, vecPred);

              1.   IN_VPR last operand is relevant only for vflpdivnr_p version.
Comments           vflpdivnr is a macro which expands into a sequence of several Vec-C
              2.
