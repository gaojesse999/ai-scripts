# Floating Point → Float Division → Vector Floating Point Division (N-R, 4

*Auto-generated from CEVA-XC4500 Vec-C Intrinsics documentation*

---

Main table → Floating Point → Float Division → Vector Floating Point Division (N-R, 4
Operations)

Vector Floating Point Division (N-R, 4 Operations)
...
Intrinsic     vflpdivnr4[_p]
name
Spec syntax   vflpdivnr4 vx[0], vz[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vflpdivnr4_p(vIn, vRes, vecPred);

              1.   IN_VPR last operand is relevant only for vflpdivnr4_p version.
Comments           vflpdivnr4 is a macro which expands into a sequence of several Vec-C
              2.
