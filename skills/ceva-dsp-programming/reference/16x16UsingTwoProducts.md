# Multiplication → Multiply-Subtract → 16x16 using Two Products

*Auto-generated from CEVA-XC4500 Vec-C Intrinsics documentation*

---

Main table → Multiplication → Multiply-Subtract → 16x16 using Two Products

16x16 using Two Products

16x16 using Two Products
Performs multiply-subtract using two products. Each source is 16-bit. The products are
subtracted from the 40-bit destination.
Available Switches
           Number of atomic operations. An atomic operation is defined as a single multiply-
Hhop
           subtract using two products operation. 9op ≤ Hhop ≤ 16op
           Number of atomic operations. An atomic operation is defined as a single multiply-
Oop
           subtract using two products operation. 1op ≤ Oop ≤ 8op
...
Intrinsic Names
vmsu3_v32_v32_v40_v40_const
vmsu3_v32_v32_v40_v40_const_vmpsX
vmsu3_v32_c32_c32_v40
vmsu3_v32_c32_c32_v40_vmpsX
vmsu3_v32_v32_v40_cn
vmsu3_v32_v32_v40_cn_vmpsX
vmsu3_v32_v32_v40_const
vmsu3_v32_v32_v40_const_vmpsX
vmsu3_v32_v32_v40
vmsu3_v32_v32_v40_vmpsX
vmsu3_v32_c32_c32_v40_v40
vmsu3_v32_c32_c32_v40_v40_vmpsX
Instruction details in the instruction set specification
Intrinsic     vmsu3_v32_v32_v40_v40_const[_p]
name
Spec syntax   vmsu3 {Hhop ,const [,vmpsX]} vx[X]p, vy[Y]p, vx[W]p, vy[V]p, voz1[0], voz2[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vRes1 = vmsu3_v32_v32_v40_v40_const_p (16, vIn, 0, LOW, vIn2, 0, LOW, 0, LOW, 0, LOW, vRes1,
              vRes2, vecPred);

                   IN_VPR last operand is relevant only for vmsu3_v32_v32_v40_v40_const_p
              1.
                   version.
...
Main table → Multiplication → Multiply-Subtract → 16x16 using Two Products
Intrinsic     vmsu3_v32_v32_v40_v40_const_vmpsX[_p]
name
Spec syntax   vmsu3 {Hhop ,const [,vmpsX]} vx[X]p, vy[Y]p, vx[W]p, vy[V]p, voz1[0], voz2[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vRes1 = vmsu3_v32_v32_v40_v40_const_vmpsX_p (16, 1, vIn, 0, LOW, vIn2, 0, LOW, 0, LOW, 0, LOW,
              vRes1, vRes2, vecPred);

                   IN_VPR last operand is relevant only for
              1.
                   vmsu3_v32_v32_v40_v40_const_vmpsX_p version.
Comments           This intrinsic returns two results. The first result variable should be placed to
              2.   the left of the = sign (lvalue). The second result variable should be passed as
                   an additional parameter (RES2_V40).
...
Main table → Multiplication → Multiply-Subtract → 16x16 using Two Products
Intrinsic     vmsu3_v32_c32_c32_v40[_p]
name
Spec syntax   vmsu3 {Oop [,vmpsX]} vx[X]p, vcYp, vx[W]p, vcVp, voz[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vRes = vmsu3_v32_c32_c32_v40_p (8, vIn, 0, LOW, vcoefIn, LOW, 0, LOW, vcoefIn2, LOW, vRes,
              vecPred);

                   IN_VPR last operand is relevant only for vmsu3_v32_c32_c32_v40_p
Comments      1.
                   version.


Main table → Multiplication → Multiply-Subtract → 16x16 using Two Products
Intrinsic     vmsu3_v32_c32_c32_v40_vmpsX[_p]
name
Spec syntax   vmsu3 {Oop [,vmpsX]} vx[X]p, vcYp, vx[W]p, vcVp, voz[0], ?vprX
...
C example   vprex_t vecPred;
            ...
            vRes = vmsu3_v32_c32_c32_v40_vmpsX_p (8, 1, vIn, 0, LOW, vcoefIn, LOW, 0, LOW, vcoefIn2, LOW,
            vRes, vecPred);

                 IN_VPR last operand is relevant only for
Comments    1.
                 vmsu3_v32_c32_c32_v40_vmpsX_p version.


Main table → Multiplication → Multiply-Subtract → 16x16 using Two Products
Intrinsic     vmsu3_v32_v32_v40_cn[_p]
name
Spec syntax   vmsu3 {Oop ,cn [,vmpsX]} vx[X]p, vy[Y]p, vx[W]p, vy[V]p, voz[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vRes = vmsu3_v32_v32_v40_cn_p (8, vIn, 0, LOW, vIn2, 0, LOW, 0, LOW, 0, LOW, vRes, vecPred);

Comments      1.   IN_VPR last operand is relevant only for vmsu3_v32_v32_v40_cn_p version.


Main table → Multiplication → Multiply-Subtract → 16x16 using Two Products
Intrinsic     vmsu3_v32_v32_v40_cn_vmpsX[_p]
name
Spec syntax   vmsu3 {Oop ,cn [,vmpsX]} vx[X]p, vy[Y]p, vx[W]p, vy[V]p, voz[0], ?vprX
...
C example   vprex_t vecPred;
            ...
            vRes = vmsu3_v32_v32_v40_cn_vmpsX_p (8, 1, vIn, 0, LOW, vIn2, 0, LOW, 0, LOW, 0, LOW, vRes,
            vecPred);

                 IN_VPR last operand is relevant only for vmsu3_v32_v32_v40_cn_vmpsX_p
Comments    1.
                 version.


Main table → Multiplication → Multiply-Subtract → 16x16 using Two Products
Intrinsic     vmsu3_v32_v32_v40_const[_p]
name
Spec syntax   vmsu3 {Oop [,const][,vmpsX]} vx[X]p, vy[Y]p, vx[W]p, vy[V]p, voz[0], ?vprX
...
vRes = vmsu3_v32_v32_v40_const_p (8, vIn, 0, LOW, vIn2, 0, LOW, 0, LOW, 0, LOW, vRes, vecPred);

                   IN_VPR last operand is relevant only for vmsu3_v32_v32_v40_const_p
Comments      1.
                   version.


Main table → Multiplication → Multiply-Subtract → 16x16 using Two Products
Intrinsic     vmsu3_v32_v32_v40_const_vmpsX[_p]
name
Spec syntax   vmsu3 {Oop [,const][,vmpsX]} vx[X]p, vy[Y]p, vx[W]p, vy[V]p, voz[0], ?vprX
...
vRes = vmsu3_v32_v32_v40_const_vmpsX_p (8, 1, vIn, 0, LOW, vIn2, 0, LOW, 0, LOW, 0, LOW, vRes,
              vecPred);

                   IN_VPR last operand is relevant only for
Comments      1.
                   vmsu3_v32_v32_v40_const_vmpsX_p version.


Main table → Multiplication → Multiply-Subtract → 16x16 using Two Products
Intrinsic     vmsu3_v32_v32_v40[_p]
name
Spec syntax   vmsu3 {Oop [,const][,vmpsX]} vx[X]p, vy[Y]p, vx[W]p, vy[V]p, voz[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vRes = vmsu3_v32_v32_v40_p (8, vIn, 0, LOW, vIn2, 0, LOW, 0, LOW, 0, LOW, vRes, vecPred);

Comments      1.   IN_VPR last operand is relevant only for vmsu3_v32_v32_v40_p version.


Main table → Multiplication → Multiply-Subtract → 16x16 using Two Products
Intrinsic     vmsu3_v32_v32_v40_vmpsX[_p]
name
Spec syntax   vmsu3 {Oop [,const][,vmpsX]} vx[X]p, vy[Y]p, vx[W]p, vy[V]p, voz[0], ?vprX
...
C example   vprex_t vecPred;
            ...
            vRes = vmsu3_v32_v32_v40_vmpsX_p (8, 1, vIn, 0, LOW, vIn2, 0, LOW, 0, LOW, 0, LOW, vRes,
            vecPred);

                 IN_VPR last operand is relevant only for vmsu3_v32_v32_v40_vmpsX_p
Comments    1.
                 version.


Main table → Multiplication → Multiply-Subtract → 16x16 using Two Products
Intrinsic     vmsu3_v32_c32_c32_v40_v40[_p]
name
Spec syntax   vmsu3 {Hhop [,vmpsX]} vx[X]p, vcYp, vx[W]p, vcVp, voz1[0], voz2[0], ?vprX
...
C example     vec_t vcoefIn2;
              vprex_t vecPred;
              ...
              vRes1 = vmsu3_v32_c32_c32_v40_v40_p (16, vIn, 0, LOW, vcoefIn, LOW, 0, LOW, vcoefIn2, LOW,
              vRes1, vRes2, vecPred);

                   IN_VPR last operand is relevant only for vmsu3_v32_c32_c32_v40_v40_p
              1.
                   version.
Comments           This intrinsic returns two results. The first result variable should be placed to
              2.   the left of the = sign (lvalue). The second result variable should be passed as
...
Main table → Multiplication → Multiply-Subtract → 16x16 using Two Products
Intrinsic     vmsu3_v32_c32_c32_v40_v40_vmpsX[_p]
name
Spec syntax   vmsu3 {Hhop [,vmpsX]} vx[X]p, vcYp, vx[W]p, vcVp, voz1[0], voz2[0], ?vprX
Return type   vec40_t
...
C example     vec_t vcoefIn2;
              vprex_t vecPred;
              ...
              vRes1 = vmsu3_v32_c32_c32_v40_v40_vmpsX_p (16, 1, vIn, 0, LOW, vcoefIn, LOW, 0, LOW, vcoefIn2,
              LOW, vRes1, vRes2, vecPred);

                   IN_VPR last operand is relevant only for
              1.
                   vmsu3_v32_c32_c32_v40_v40_vmpsX_p version.
Comments           This intrinsic returns two results. The first result variable should be placed to
              2.   the left of the = sign (lvalue). The second result variable should be passed as
                   an additional parameter (RES2_V40).
