# Multiplication → Multiply and Add Two Products → 16x16 Multiply and

*Auto-generated from CEVA-XC4500 Vec-C Intrinsics documentation*

---

Main table → Multiplication → Multiply and Add Two Products → 16x16 Multiply and
Add Two Products

16x16 Multiply and Add Two Products

16x16 Multiply and Add Two Products
Performs multiplication and addition between two products. Each source is 16-bit wide. The
result is placed into 40-bit destination.
Available Switches
           Number of atomic operations. An atomic operation is defined as a single add-two-
Hhop
           products operation. 9op ≤ Hhop ≤ 16op
           Number of atomic operations. An atomic operation is defined as a single add-two-
Oop
           products operation. 1op ≤ Oop ≤ 8op
...
Intrinsic Names
vmad_v32_v32_v32_cn
vmad_v32_v32_v32_cn_vmpsX
vmad_v32_v32_v32_v32_const
vmad_v32_v32_v32_v32_const_vmpsX
vmad_v32_v32_v32_const
vmad_v32_v32_v32_const_vmpsX
vmad_v32_v32_v32
vmad_v32_v32_v32_vmpsX
vmad_v32_c32_c32_v32_v32
vmad_v32_c32_c32_v32_v32_vmpsX
vmad_v32_c32_c32_v32
vmad_v32_c32_c32_v32_vmpsX
Instruction details in the instruction set specification
Intrinsic     vmad_v32_v32_v32_cn[_p]
name
Spec syntax   vmad {Oop ,cn [,vmpsX]} vx[X]p, vy[Y]p, vx[W]p, vy[V]p, vz[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vRes = vmad_v32_v32_v32_cn_p (8, vIn, 0, LOW, vIn2, 0, LOW, 0, LOW, 0, LOW, vecPred);

Comments      1.   IN_VPR last operand is relevant only for vmad_v32_v32_v32_cn_p version.


Main table → Multiplication → Multiply and Add Two Products → 16x16 Multiply and
Add Two Products
Intrinsic     vmad_v32_v32_v32_cn_vmpsX[_p]
name
Spec syntax   vmad {Oop ,cn [,vmpsX]} vx[X]p, vy[Y]p, vx[W]p, vy[V]p, vz[0], ?vprX
...
C example   vprex_t vecPred;
            ...
            vRes = vmad_v32_v32_v32_cn_vmpsX_p (8, 1, vIn, 0, LOW, vIn2, 0, LOW, 0, LOW, 0, LOW, vecPred);

                 IN_VPR last operand is relevant only for vmad_v32_v32_v32_cn_vmpsX_p
Comments    1.
                 version.
...
Main table → Multiplication → Multiply and Add Two Products → 16x16 Multiply and
Add Two Products
Intrinsic     vmad_v32_v32_v32_v32_const[_p]
name
Spec syntax   vmad {Hhop ,const [,vmpsX]} vx[X]p, vy[Y]p, vx[W]p, vy[V]p, vz1[0], vz2[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vRes1 = vmad_v32_v32_v32_v32_const_p (16, vIn, 0, LOW, vIn2, 0, LOW, 0, LOW, 0, LOW, vRes2,
              vecPred);

                   IN_VPR last operand is relevant only for vmad_v32_v32_v32_v32_const_p
              1.
                   version.
...
Main table → Multiplication → Multiply and Add Two Products → 16x16 Multiply and
Add Two Products
Intrinsic     vmad_v32_v32_v32_v32_const_vmpsX[_p]
name
Spec syntax   vmad {Hhop ,const [,vmpsX]} vx[X]p, vy[Y]p, vx[W]p, vy[V]p, vz1[0], vz2[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vRes1 = vmad_v32_v32_v32_v32_const_vmpsX_p (16, 1, vIn, 0, LOW, vIn2, 0, LOW, 0, LOW, 0, LOW,
              vRes2, vecPred);

                   IN_VPR last operand is relevant only for
              1.
                   vmad_v32_v32_v32_v32_const_vmpsX_p version.
Comments           This intrinsic returns two results. The first result variable should be placed to
              2.   the left of the = sign (lvalue). The second result variable should be passed as
                   an additional parameter (RES2_V32).
...
Main table → Multiplication → Multiply and Add Two Products → 16x16 Multiply and
Add Two Products
Intrinsic     vmad_v32_v32_v32_const[_p]
name
Spec syntax   vmad {Oop [,const][,vmpsX]} vx[X]p, vy[Y]p, vx[W]p, vy[V]p, vz[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vRes = vmad_v32_v32_v32_const_p (8, vIn, 0, LOW, vIn2, 0, LOW, 0, LOW, 0, LOW, vecPred);

                   IN_VPR last operand is relevant only for vmad_v32_v32_v32_const_p
Comments      1.
                   version.
...
Main table → Multiplication → Multiply and Add Two Products → 16x16 Multiply and
Add Two Products
Intrinsic     vmad_v32_v32_v32_const_vmpsX[_p]
name
Spec syntax   vmad {Oop [,const][,vmpsX]} vx[X]p, vy[Y]p, vx[W]p, vy[V]p, vz[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vRes = vmad_v32_v32_v32_const_vmpsX_p (8, 1, vIn, 0, LOW, vIn2, 0, LOW, 0, LOW, 0, LOW,
              vecPred);

                   IN_VPR last operand is relevant only for
Comments      1.
                   vmad_v32_v32_v32_const_vmpsX_p version.


Main table → Multiplication → Multiply and Add Two Products → 16x16 Multiply and
Add Two Products
Intrinsic     vmad_v32_v32_v32[_p]
name
Spec syntax   vmad {Oop [,const][,vmpsX]} vx[X]p, vy[Y]p, vx[W]p, vy[V]p, vz[0], ?vprX
...
C example     vprex_t vecPred;
              ...
              vRes = vmad_v32_v32_v32_p (8, vIn, 0, LOW, vIn2, 0, LOW, 0, LOW, 0, LOW, vecPred);

Comments      1.   IN_VPR last operand is relevant only for vmad_v32_v32_v32_p version.


Main table → Multiplication → Multiply and Add Two Products → 16x16 Multiply and
Add Two Products
Intrinsic     vmad_v32_v32_v32_vmpsX[_p]
name
Spec syntax   vmad {Oop [,const][,vmpsX]} vx[X]p, vy[Y]p, vx[W]p, vy[V]p, vz[0], ?vprX
...
C example   vprex_t vecPred;
            ...
            vRes = vmad_v32_v32_v32_vmpsX_p (8, 1, vIn, 0, LOW, vIn2, 0, LOW, 0, LOW, 0, LOW, vecPred);

                 IN_VPR last operand is relevant only for vmad_v32_v32_v32_vmpsX_p
Comments    1.
                 version.
...
Main table → Multiplication → Multiply and Add Two Products → 16x16 Multiply and
Add Two Products
Intrinsic     vmad_v32_c32_c32_v32_v32[_p]
name
Spec syntax   vmad {Hhop [,vmpsX]} vx[X]p, vcYp, vx[W]p, vcVp, vz1[0], vz2[0], ?vprX
...
C example     vec_t vcoefIn2;
              vprex_t vecPred;
              ...
              vRes1 = vmad_v32_c32_c32_v32_v32_p (16, vIn, 0, LOW, vcoefIn, LOW, 0, LOW, vcoefIn2, LOW,
              vRes2, vecPred);

                   IN_VPR last operand is relevant only for vmad_v32_c32_c32_v32_v32_p
              1.
                   version.
Comments           This intrinsic returns two results. The first result variable should be placed to
              2.   the left of the = sign (lvalue). The second result variable should be passed as
...
Main table → Multiplication → Multiply and Add Two Products → 16x16 Multiply and
Add Two Products
Intrinsic     vmad_v32_c32_c32_v32_v32_vmpsX[_p]
name
Spec syntax   vmad {Hhop [,vmpsX]} vx[X]p, vcYp, vx[W]p, vcVp, vz1[0], vz2[0], ?vprX
...
C example   vec_t vcoefIn2;
            vprex_t vecPred;
            ...
            vRes1 = vmad_v32_c32_c32_v32_v32_vmpsX_p (16, 1, vIn, 0, LOW, vcoefIn, LOW, 0, LOW, vcoefIn2,
            LOW, vRes2, vecPred);

                 IN_VPR last operand is relevant only for
            1.
                 vmad_v32_c32_c32_v32_v32_vmpsX_p version.
Comments         This intrinsic returns two results. The first result variable should be placed to
            2.   the left of the = sign (lvalue). The second result variable should be passed as
                 an additional parameter (RES2_V32).
...
Main table → Multiplication → Multiply and Add Two Products → 16x16 Multiply and
Add Two Products
Intrinsic     vmad_v32_c32_c32_v32[_p]
name
Spec syntax   vmad {Oop [,vmpsX]} vx[X]p, vcYp, vx[W]p, vcVp, vz[0], ?vprX
...
C example     coef_t vcoefIn2;
              vprex_t vecPred;
              ...
              vRes = vmad_v32_c32_c32_v32_p (8, vIn, 0, LOW, vcoefIn, LOW, 0, LOW, vcoefIn2, LOW, vecPred);

Comments      1.   IN_VPR last operand is relevant only for vmad_v32_c32_c32_v32_p version.


Main table → Multiplication → Multiply and Add Two Products → 16x16 Multiply and
Add Two Products
Intrinsic     vmad_v32_c32_c32_v32_vmpsX[_p]
name
Spec syntax   vmad {Oop [,vmpsX]} vx[X]p, vcYp, vx[W]p, vcVp, vz[0], ?vprX
...
C example   vprex_t vecPred;
            ...
            vRes = vmad_v32_c32_c32_v32_vmpsX_p (8, 1, vIn, 0, LOW, vcoefIn, LOW, 0, LOW, vcoefIn2, LOW,
            vecPred);

                 IN_VPR last operand is relevant only for vmad_v32_c32_c32_v32_vmpsX_p
Comments    1.
                 version.
