# Generic → Generic Multiply-Accumulate → 16x16 MAC3

*Auto-generated from CEVA-XC4500 Vec-C Intrinsics documentation*

---

Main table → Generic → Generic Multiply-Accumulate → 16x16 MAC3
...
configured according to the configuration register set. Each source is 16-bit wide. The
...
Intrinsic Names
vgenmac3_v32_v32_v40
Instruction details in the instruction set specification
Intrinsic     vgenmac3_v32_v32_v40[_p]
name
Spec syntax   vgenmac3 {Oop [,cfgX]} vx, vy, voz[0], ?vprX
...
C example     vec_t vcfgIn;
              vprex_t vecPred;
              ...
              vRes = vgenmac3_v32_v32_v40_p (8, vcfgIn, vIn, vIn2, vRes, vecPred);

Comments      1.   IN_VPR last operand is relevant only for vgenmac3_v32_v32_v40_p version.
